     ...
     #   result = [interval]
      ...
      #  conf_score =  np.max(classifier.predict_proba([result]))*100
        if prediction == 1 :
            ...
            context ={'a':list(pred),'temp':temp,'y1':pred[0],'y2':pred[1],'y3':pred[2],'y4':pred[3],'y5':pred[4],'y6':pred[5],'y7':pred[6],'y8':pred[7],'y9':pred[8],'y10':pred[9],'y11':pred[10],'y12':pred[11] }
